                            ...
                            <fo:table-body>
                                <fo:table-row font-size="18pt" line-height="30px" background-color="#1f6a9c" color="white" font-weight = "bold">
                                    <fo:table-cell padding-left="5pt">
                                        <fo:block>
                                            <fo:external-graphic  src="url(file:///C:/Users/91856/Desktop/POS/Invoice/src/main/resources/images/logo.png)" content-height="scale-to-fit" height="50px"  content-width="2.00in" scaling="non-uniform"/>
                                        </fo:block>
                                    </fo:table-cell>
